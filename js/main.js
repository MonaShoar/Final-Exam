...
let upperCaseNames = emptyArray.map(name => name.toUpperCase());


// Step 6: Create an event listener that fires a callback function when the aside h2 is clicked. It should alert "Hello from Boo the World's Cutest Dog!";co

document.querySelector('aside h2').addEventListener('click', function() {
